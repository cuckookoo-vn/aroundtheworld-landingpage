                ...
                windowDimensions.width > 767.5 ?
                    <>
                        <video data-aos="fade-up"
                            ...
                            <source src="https://aroundtheworld.s3.ap-southeast-1.amazonaws.com/video/artw_ckk_minigame_web.mp4"
                                    type="video/mp4"/>
                        </video>
                    ...
                    <>
                        <div className="mobile-box hidden-pc">
                            <video autoPlay muted loop
                                   ...
                                   data-aos="fade-up"
                                   data-aos-delay="800">
                                <source src="https://aroundtheworld.s3.ap-southeast-1.amazonaws.com/video/artw_ckk_minigame_mobile_1.mp4"
                                        type="video/mp4"/>
                            </video>
                        ...
                        <div className="mobile-box hidden-pc">
                            <video autoPlay muted loop
                                   ...
                                   data-aos="fade-up"
                                   data-aos-delay="800">
                                <source src="https://aroundtheworld.s3.ap-southeast-1.amazonaws.com/video/artw_ckk_minigame_mobile_2.mp4"
                                        type="video/mp4"/>
                            </video>
                            <div className="button-mobile">
                                <div className="button"
                        ...
                        <div className="mobile-box hidden-pc"
                            ...
                            <video autoPlay muted loop
                                   ...
                                   data-aos="fade-up"
                                   data-aos-delay="800">
                                <source src="https://aroundtheworld.s3.ap-southeast-1.amazonaws.com/video/artw_ckk_minigame_mobile_3.mp4"
                                        type="video/mp4"/>
                            </video>
                            <div className="button-mobile">
                                <div className="button"
