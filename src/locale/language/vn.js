...
vn = {
    translation: {
        ...
        introduce: {
            ...
            title1: " là trò chơi mang đến cho người chơi trải nghiệm du lịch vòng quanh thế giới. " +
                "Game rất thích hợp cho những ai có đam mê tìm hiểu những nét văn hóa đặc trưng của các quốc " +
                "gia, vùng miền. Hơn hết, đây không chỉ là một trò chơi mà còn là một cách giáo dục trẻ em về " +
                "thế giới đa dạng và đầy màu sắc..",
        ...
        roadMap: {
            ...
            rm21: {
                ...
                title4: "Nâng cấp máy chủ (~ 10.000.000 người chơi)",
                title5: "Phát triển Blockchain trong ARTW",
                title6: "Chuẩn bị cho giai đoạn 3",
            ...
            rm22: {
                ...
                title4: "Chạy quảng cáo trong ứng dụng (tập trung vào F&B)",
